...
## Overview
The AWS EMR Plugin integrates RightScale Self-Service with the basic functionality of the AWS EMR API.
...
1. In the Design section, use the `Upload CAT` interface to complete the following:
   ...
   1. Upload the `aws_emr_plugin.rb` file located in this repository

## How to Use
The EKS Plugin has been packaged as `plugins/rs_aws_emr`. In order to use this plugin you must import this plugin into a CAT.
```
