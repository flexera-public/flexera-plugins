...
| parameter_n_name | no | The key associated with the parameter. If you don't specify a key and value for a particular parameter, AWS CloudFormation uses the default value that is specified in your template. Where `n` equals 1-40 (ie. `parameter_1_name`). `parameter_1_name` and `parameter_1_value` create a hash of a single CFT parameter, etc. | | 
| parameter_n_value | no | The value associated with the parameter. Where `n` equals 1-40 (ie. `parameter_1_value`).  `parameter_1_name` and `parameter_1_value` create a hash of a single CFT parameter, etc. |
