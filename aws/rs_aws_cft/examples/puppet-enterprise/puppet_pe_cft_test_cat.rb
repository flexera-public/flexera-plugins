name "CFT Puppet Enterprise CAT"
rs_ca_ver 20161221
short_description  "CFT Puppet Enterprise CAT"
...
resource "stack", type: "rs_aws_cft.stack" do
  stack_name join(["cft-puppet-enterprise-", last(split(@@deployment.href, "/"))])
  stack_policy_url ""
  parameter_1_name "AssociatePublicIpAddress"
  parameter_1_value "true"
  parameter_2_name "CodeManagerAccess"
  parameter_2_value "true"
  parameter_3_name "R10KRemote"
  parameter_3_value "git://github.com/rs-services/control-repo-example.git"
  parameter_4_name "SecurityGroupIds"
  parameter_4_value "sg-d94b17a8,sg-b9421ac8"
  parameter_5_name "SSHAccess"
  parameter_5_value "true"
  description "CFT Puppet Enterprise"
end
