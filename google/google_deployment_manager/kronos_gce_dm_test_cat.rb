...
define gen_launch(@gce_dm_deployment,$gce_project) return @gce_dm_deployment, @bt_deployment do
  ...
  $additional_imports = [
    { "name" => "beyondtrust.jinja", "url" => "https://storage.googleapis.com/rightscale-test/DeploymentManager/beyondtrust.jinja" },
    { "name" => "beyondtrust.jinja.schema", "url" => "https://storage.googleapis.com/rightscale-test/DeploymentManager/beyondtrust.jinja.schema"},
    { "name" => "beyondtrust.jinja.display", "url" => "https://storage.googleapis.com/rightscale-test/DeploymentManager/beyondtrust.jinja.display"},
    { "name" => "password.py", "url" => "https://storage.googleapis.com/rightscale-test/DeploymentManager/password.py"},
    { "name" => "path_utils.jinja", "url" => "https://storage.googleapis.com/rightscale-test/DeploymentManager/path_utils.jinja"},
    { "name" => "test_config.yaml", "url" => "https://storage.googleapis.com/rightscale-test/DeploymentManager/test_config.yaml"},
    { "name" => "resources/en-us/beyondtrust_small.png", "url" => "https://storage.googleapis.com/rightscale-test/DeploymentManager/beyondtrust_small.png"},
    { "name" => "resources/en-us/beyondtrust_store.png", "url" => "https://storage.googleapis.com/rightscale-test/DeploymentManager/beyondtrust_store.png"}
  ]
