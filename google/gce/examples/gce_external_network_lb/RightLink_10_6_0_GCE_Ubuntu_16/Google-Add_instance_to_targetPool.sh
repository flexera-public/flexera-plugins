#!/bin/bash -ex
# ---
# RightScript Name: Google - Add instance to targetPool
# Description: Adds current instance to targetPool
# Inputs:
#   GCE_SERVICE_ACCOUNT:
#     Category: GCE
#     Description: The GCE Service Account to use to add the instance to the targetPool.
#     Input Type: single
#     Required: true
#     Advanced: false
#   GCE_SERVICE_ACCOUNT_JSON:
#     Category: GCE
#     Description: The GCE Service Account Private Key JSON to use to add the instance
#       to the targetPool.
#     Input Type: single
#     Required: true
#     Advanced: false
#   TARGET_POOL:
#     Category: GCE
#     Description: The targetPool name to add the instance to.
#     Input Type: single
#     Required: true
#     Advanced: false
# Attachments: []
...
gcloud compute target-pools add-instances $TARGET_POOL --instances $instance_name --instances-zone $instance_zone
